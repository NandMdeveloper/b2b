...
<!-- Navigation -->
        <nav id="header" class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="adminC.php?status=a"><img class="col-xs-8" src="../image/logo_b2b.svg" style="width: 100px; margin-top: 8px;"/></a>
            </div>
            <!-- /.navbar-header -->
            <div id="user-nav">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="adminC.php?status=a"><span>Aprobados</span></a>
                                </li>
                                <li>
                                    <a href="adminC.php?status=c"><span>Confirmados</span></a>
                                </li>
                                
                                <li>
                                    <a href="adminC.php?status=l"><span>Anulados</span></a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="creditos.php"><i class="fa fa-money fa-fw"></i><span> Créditos</span></a>
                        </li>
                        <li>
