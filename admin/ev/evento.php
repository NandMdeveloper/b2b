...
if($_POST){
    $rif=$_POST["rif"];
    $sql=@mysql_query("SELECT * FROM clientes WHERE rif='$rif'");
...
<?php require_once('../lib/php/common/menuE.php'); ?>
    <div id="content">
        <div class="col-lg-12">
            <h1 class="page-header">Evento Pro-Acce</h1>
        </div>
        <div class="col-lg-12">
                    ...
                    <form class="form-horizontal" role="form2" action="reg.php" method="POST">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" placeholder="Rif" name="riff" type="text" title="Ejemplo: J000000000" pattern="^[JGV][0-9]{9}$" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-5">
