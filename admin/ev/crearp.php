        ...
        <div id="content">
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <form role="form" id='Form' name="Form" action="procesar.php" method="POST">
                        <!-- /.panel-heading -->
                        <div class="row">
                            <div class="col-xs-12"><h3>Clientes: </h3>
                                <select id="cliente" name="cliente" class="selectpicker" data-size="6" data-live-search="true" title="Seleccione Cliente..." onchange="document.getElementById('product').style.visibility='visible';" data-style="btn-warning" data-width="100%"  required>
                        ...
                        <div class="row">
                            <hr>
                            <div id="product" class="col-xs-12" style="visibility: hidden;"><h3>Productos: </h3>
