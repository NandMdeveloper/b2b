                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-4 col-xs-3 col-lg-4 text-center">
                            ...
                            foreach($_POST['productos'] as $producto){
                                ...
                                $qu="SELECT artunidad.co_uni, artunidad.equivalencia, artunidad.co_art FROM artunidad WHERE artunidad.co_art = '".$producto."'";
                                $res = @mysql_query($qu);
                                echo '<div id="pd'.$t.'" class="row list_pro_pedido_mod">
                                            ...
                                            <?php echo '</span> 
                                                        <input type="text" size="80" class="form-control descrip" name="descripcion'.$t.'" id="descripcion'.$t.'" value="'.$row["art_des"].'" readonly/>
                                            ...
                                            <div class="col-sm-2 col-xs-1 col-lg-2 text-center">';
                                                ?>
                                                    <select class="form-control" id="<?php echo 'unidad'.$t; ?>" name="<?php echo 'unidad'.$t; ?>" required>
                                                    <?php while ($rows = mysql_fetch_array($res)) {
                                                        echo '<option value="'.$rows["co_uni"].'">'.$rows["co_uni"].'</option>';
                                                    } ?>
                                                    </select>
                                                <?php
