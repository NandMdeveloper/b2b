...
if(sizeof($arr_detalles_pedido)>1){
    ...
    if($resp){
        ...
        echo '<script type="text/javascript">window.location="detallePedidoE.php?id='.$pedido.'";</script>';
    }else{
        echo '<script type="text/javascript">alert("Ha ocurrido un error, intente eliminar el producto nuevamente por favor...");window.location="detallePedidoE.php?id='.$pedido.'";</script>';
    }
}else{
    echo '<script type="text/javascript">alert("Debera anular el pedido ya que tiene solo un articulo...");window.location="detallePedidoE.php?id='.$pedido.'";</script>';
}
?>
