...
if($bool){
    ?>
       <script type="text/javascript">window.location="admin.php?status=e";</script>
    <?php
}else{
    ?>                
       <script type="text/javascript">alert("Ocurrio un problema al enviar su mensaje, intentelo nuevamente...");history.go(-1);</script>
    <?php
}
