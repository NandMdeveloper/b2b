...
if($_SESSION['tipo']!='11') header('Location: ../lib/php/common/logout.php');
...
<?php require_once('../lib/php/common/menu.php'); ?>
            <div id="content">
                <div class="col-lg-12">
                    <h1 class="page-header">Pedidos en Pre-Despacho</h1>
                </div>
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-sm-4"><h5 class="box-title"><strong>Detalles del Pedido # <?php echo $id; ?></strong></h5></div>
