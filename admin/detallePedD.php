                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-3 text-center">
                                   <a href="adminD.php?status=c"><button type="button" class="btn btn-info">Regresar</button></a>
                                </div>
                                
                                <div class="col-xs-3 text-center">
                                    <a href="aprobarD.php?id=<?php echo $pedido; ?>"><button type="submit" class="btn btn-success" >Despachar Pedido</button></a>
                                </div>
                            </div>
                        </div>
                        <!-- .panel-body -->
