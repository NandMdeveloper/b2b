...
conectar();
    ...
    $query3="UPDATE pedidos_tes SET status=1, fecha_dis='$fecha', motivoA='$observaciones' WHERE id_pedido=$pedido";
    ...
    if($ro){
        ...
        $mensaje="Por medio del siguiente correo le indicamos que su pago correspondiente al pedido #$pedido fue abonado exitosamente";
