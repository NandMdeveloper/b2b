                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        switch($status){
                                            case "r":
                                                $query = "SELECT * FROM pedidos_tes WHERE status=0 AND revisado=1 ORDER BY id_pedido DESC";
                                                ...
                                                while ($row = mysql_fetch_array($result)) {
                                                    echo '<tr class="odd gradeX">
                                                        ...
                                                        <td class="center"><form action="detallePedT.php" method="POST">
                                            ...
                                            case "a":
                                                ...
                                                while ($row = mysql_fetch_array($result)) {
                                                    echo '<tr class="odd gradeX">
                                                        ...
                                                        <td class="center">'.$row["fecha"].'</td>
                                                        <td class="center">'.$row["tipo_pago"].'</td>
                                                        <td class="center"><form action="detallePed.php" method="POST">
                                                        <button name="id" type="submit" class="btn btn-success btn-xs btn-block" value="'.$row["id_pedido"].'">Ver</button>
                                                        </form></td>
                                                        </tr>';
                                                }
