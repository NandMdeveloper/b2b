...
<body>
    ...
    <?php require_once('menuC.php'); ?>
        ...
        <div id="content">
                <div class="col-lg-12">
                    <h1 class="page-header">Detalle Pedidos - Crédito y Cobranzas</h1>
                </div>
                <!-- /.col-lg-12 -->
            <div class="row">
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-3 text-center">
                                   <a href="adminC.php?status=a"><button type="button" class="btn btn-info">Regresar</button></a>
                                </div>
                                <div class="col-xs-3 text-center">
                                    <a href="anularC.php?id=<?php echo $pedido; ?>"><button type="submit" class="btn btn-danger" >Anular Pedido</button></a>
                                </div>
                                <div class="col-xs-3 text-center">
                                    <a href="aprobarPedC.php?id=<?php echo $pedido; ?>"><button type="submit" class="btn btn-success" >Confirmar Pedido</button></a>
                                </div>
                            </div>
                        </div>
                        <!-- .panel-body -->
