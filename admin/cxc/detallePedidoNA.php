...
<?php require_once('../lib/php/common/menuT.php'); ?>
                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php }
                            $arr_pedidos=$obj_pedidos->get_pedido_ANP($pedido); ?>
                            <br>
                                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3 text-center">
                                   <a href="adminT.php?status=q"><button type="button" class="btn btn btn-primary btn-block"><i class="fa fa-reply"></i> Regresar</button></a>
                                </div>
                            </div>
    ...
    var id = $(this).data('id');
        ...
        if (eliminar)
            window.location.href = "anular_ped_cn.php?codigo="+id;
    });
</script>
</body>
