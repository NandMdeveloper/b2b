<?php
	...
	$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('L2', "SEGMENTO");
	$objPHPExcel->setActiveSheetIndex(0) ->setCellValue('M2', "COD CLI");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N2', "CLIENTE");
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O2', "VENCIDO >21");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P2', "VENCIDO 15-21");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q2', "VENCIDO 8-14");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R2', "VENCIDO 7-1");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S2', "VENCIDO HOY");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T2', "A VENCER 1-7");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U2', "A VENCER 8-14");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V2', "A VENCER 15-21");
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W2', "A VENCER >21");
	...
	for($i=0;$i < $lineas; $i++){
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('M'.$pos, (int)$vencidos[$i]['co_prov']);
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N'.$pos,utf8_encode($vencidos[$i]['prov_des']) );
		...
		if ($vencidos[$i]['co_seg']==000004){
			$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$pos,utf8_encode('CUENTAS CLAVES') );
		}
		elseif ($vencidos[$i]['co_seg']==000005){
			$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$pos,utf8_encode('TRADICIONAL') );
		}
		elseif ($vencidos[$i]['co_seg']=='DET'){
			$objPHPExcel->setActiveSheetIndex(0)->setCellValue('L'.$pos,utf8_encode('DETAL') );
		}
		// Vencidos
		if($vencidos[$i]['diferencia'] < 0 and $vencidos[$i]['diferencia'] !="N"){
			$neg=$vencidos[$i]['diferencia']*-1;
			if($neg>21){
				$objPHPExcel->setActiveSheetIndex(0)->setCellValue('O'.$pos, $nsaldo);
...
$objPHPExcel->getActiveSheet()->setAutoFilter('A2:W'.$lineas);
