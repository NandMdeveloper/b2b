...
<?php require_once('../lib/php/common/menuT.php'); ?>
            <div id="content">
                <div class="col-lg-12">
                    <h1 class="page-header">Pedidos Entregados</h1>
                </div>
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <div class="col-sm-4"><h3 class="box-title"><strong>Pedido # <?php echo $id; ?> | Factura # <?php echo $arr_dat[0]['factura']; ?></strong></h3></div>
                          <div class="col-sm-4"><h3 class="box-title"><strong>Cliente: <?php echo $arr_dat[0]['co_cli'].'-'.utf8_encode($arr_dat[0]['cli_des']); ?></strong></h3></div>
                          <div class="col-sm-4"><h3 class="box-title"><strong>Vendedor: <?php echo $arr_dat[0]['co_ven'].'-'.$arr_dat[0]['ven_des']; ?></strong></h3></div>
