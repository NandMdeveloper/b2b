                ...
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php $arr_dp=$obj_pedidos->get_ped_det_app($pedido);
                            ...
                            <div class="row">
                                <div class="col-xs-3 text-center">
                                  <button type="button" class="btn btn btn-primary btn-block" onClick='javascript:history.go(-1);'><i class="fa fa-reply"></i> Regresar</button>
                                   <!--<a href="adminT.php?status=a"><button type="button" class="btn btn btn-primary btn-block"><i class="fa fa-reply"></i> Regresar</button></a>-->
                                </div>
                            </div>
