<?php
    ...
    <?php require_once('../lib/php/common/menuD.php'); ?>
                <div id="content">
                    <div class="col-lg-12">
                        <h1 class="page-header">Pedidos para Facturar</h1>
                    </div>
                    <div class="col-lg-12">
                  ...
                  <div class="col-sm-3"><h5 class="box-title"><strong>Vendedor: <?php echo $co_ven.'-'.$ven_des; ?></strong></h5></div>
                                <div class="dataTable_wrapper">
                                    ...
                                    <div class="col-xs-3">
                        <button name="id" type="button" class="btn btn-primary btn-block desp" data-id="<?php echo $id; ?>"><i class="fa fa-check-circle"></i> Facturar</button>
                    </div>
                    <?php if($imp==0){ ?>
                    <div class="col-xs-3">
                        <button name="id" type="button" class="btn btn-primary btn-block imp" data-id="<?php echo $id; ?>" ><i class="fa fa-check-circle"></i> Imprimir</button>
                    </div> <?php } ?>
                    <div class="col-xs-3">
