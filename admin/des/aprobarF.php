            ...
            <div id="content">
              ...
              <div class="col-sm-3"><h5 class="box-title"><strong>Vendedor: <?php echo $co_ven.'-'.$ven_des; ?></strong></h5></div>
                            <div class="dataTable_wrapper">
                                <form class="form-inline" action="aprobarFact.php" method="POST">
                                  <div class="row">
                                  <div class="col-xs-12">
                  ...
                  <input type="textarea" name="comentario" class="form-control" value="" required/>
                                  ...
                                  <div class="col-xs-3">
                                    <a href="detallePedidoDesA.php?id=<?php echo $id; ?>"><button type="button" class="btn btn btn-primary btn-block"><i class="fa fa-reply"></i> Regresar</button></a>
                                  </div>
                                </form>
                            </div>
                        </div>
