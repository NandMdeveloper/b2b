            ...
            <div id="content">
              ...
              <div class="col-sm-3"><h5 class="box-title"><strong>Vendedor: <?php echo $co_ven.'-'.$ven_des; ?></strong></h5></div>
                            <div class="dataTable_wrapper">
                                ...
                                <div class="col-xs-3">
                                    <button type="button" class="btn btn-primary btn-block desp" data-id="<?php echo $id; ?>"><i class="fa fa-check-circle"></i> Despachar</button>
                                </div>
                                <div class="col-xs-3">
...
<script>
    ...
    var id = $(this).data('id');
        ...
        if (eliminar)
            window.location.href = "anularD.php?id="+id;
    });
</script>
<script>
    ...
    var id = $(this).data('id');
        ...
        if (eliminar)
            window.location.href = "modificarF.php?id="+id;
    });
</script>
</body>
