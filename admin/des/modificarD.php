...
$fechaD=$arr_dat[0]['fecha_despacho'];
?>
<!DOCTYPE html>
<html lang="es">
...
<?php require_once('../lib/php/common/menuD.php'); ?>
            <div id="content">
                <div class="col-lg-12">
                    <h1 class="page-header">Pedidos para Despachar</h1>
                </div>
                <div class="col-lg-12">
              ...
              <div class="col-sm-3"><h5 class="box-title"><strong>Vendedor: <?php echo $co_ven.'-'.$ven_des; ?></strong></h5></div>
                            <div class="dataTable_wrapper">
                                <form class="form-inline" action="modD.php" method="POST">
                                  <div class="row">
                                  <div class="col-xs-12">
                <div class="form-group">
                  <label for="fecha">Fecha Despacho: </label>
                  <input type="date" name="fecha_old" class="form-control" value="<?php echo $fechaD; ?>" readonly required/>
              ...
              <div class="col-xs-3">
                <a href="detallePedidoDesF.php?id=<?php echo $id; ?>"><button type="button" class="btn btn btn-primary btn-block"><i class="fa fa-reply"></i> Regresar</button></a>
              </div>
                                </form>
                            </div>
                        </div>
