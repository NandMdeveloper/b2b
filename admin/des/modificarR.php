...
$fechaR=$arr_dat[0]['fecha_recibido'];
?>
<!DOCTYPE html>
<html lang="es">
            ...
            <div id="content">
              ...
              <div class="col-sm-3"><h5 class="box-title"><strong>Vendedor: <?php echo $co_ven.'-'.$ven_des; ?></strong></h5></div>
                            <div class="dataTable_wrapper">
                                <form class="form-inline" action="modR.php" method="POST">
                                  <div class="row">
                                  <div class="col-xs-12">
                <div class="form-group">
                  <label for="fecha">Fecha Recibido: </label>
                  <input type="date" name="fecha_old" class="form-control" value="<?php echo $fechaR; ?>" readonly required/>
