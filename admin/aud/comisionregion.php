      ...
      <div class="row">
          <div class="col-xs-8">
            <div class="panel panel-default">
                <div class="panel-heading">Crear una región</div>
                <div class="panel-body">
      									<form class="form-horizontal" method="post" action="controlcomisiones.php?opcion=agregarregion">
					  <fieldset>
						<div class="form-group">
						  <label for="inputEmail" class="col-lg-2 control-label">Nombre</label>
						  <div class="col-lg-10">
							<input class="form-control" name="nombre"  id="nombre" placeholder="Nombre para la región" type="text" required  pattern=".{5,25}" maxlength="25" >
						  </div>
						</div>
						<div class="form-group">
                ...
                <div class="checkbox">
                  <label>
                  <input type="checkbox" id="estatus"  name="estatus" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="" data-original-title="La comisión será permanente"> Activo
                  </label>
                </div>
							</div>
						</div>
