      ...
      <div class="row">
          <div class="col-xs-8">
            <div class="panel panel-default">
                <div class="panel-heading">Crear gerente ventas</div>
                <div class="panel-body">
 					<form class="form-horizontal" method="post" action="controlcomisiones.php?opcion=agregargerenteventa">
					  <fieldset>
						<div class="form-group">
						  <label for="inputEmail" class="col-lg-2 control-label">Nombre</label>
						  <div class="col-lg-4">
							<input class="form-control" name="nombre"  id="nombre" placeholder="Nombre del gerente" type="text" required  pattern=".{3,25}" maxlength="25" >
						  </div>
						  <label for="inputEmail" class="col-lg-2 control-label">Apellido</label>
						  <div class="col-lg-4">
							<input class="form-control" name="apellido"  id="apellido" placeholder="Apellido del gerente" type="text" required  pattern=".{3,25}" maxlength="25" >
						  </div>
						</div>
				<div class="form-group">
