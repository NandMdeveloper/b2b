...
$meta=$comision->getMetasVendedores(null,$idm,$desde,$hasta);
      ...
      <div class="row">
          <div class="col-xs-8">
            <div class="panel panel-default">
                <div class="panel-heading">Editar presupuesto</div>
                <div class="panel-body">
                  <form class="form-horizontal" method="post" action="controlcomisiones.php?opcion=editarMetaVendedor">
                    <input type="hidden" value="<?php echo $idm; ?>" name="idm">
                    <fieldset>
                    <legend>Editar meta vendedor</legend>
                    <?php

                  $nPresupuesto =  str_replace(".", ",", $meta[0]['presupuesto'])
                     ?>
                     <div class="form-group">
                      <label for="select" class="col-lg-2 control-label">Región</label>
                      <div class="col-lg-10">
                        <select class="form-control" name="region" disabled>
                          <option value="<?php echo $meta[0]['id']?>"><?php echo $meta[0]['ven_des']." (".$meta[0]['co_ven'].")";?></option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                      <input class="form-control preciosforma" name="presupuesto"  id="presupuesto" placeholder="Presupuesto para la región" type="text" required  pattern=".{0,25}" maxlength="25" value="<?php echo $nPresupuesto; ?>" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputEmail" class="col-lg-2 control-label">Inicio</label>
                      <div class="col-lg-3">
                      <input class="form-control fecha" name="desde" id="desde" placeholder="Fecha inicio" type="text" required  value="<?php echo $meta[0]['desde']?>">
                      </div>
                      <label for="inputEmail" class="col-lg-2 control-label">Final</label>
                      <div class="col-lg-3">
                      <input class="form-control fecha" name="hasta" id="hasta" placeholder="Fecha de finalización 1" type="text" required  value="<?php echo $meta[0]['hasta']?>">
                      </div>
                    </div>
                    <div class="form-group">
