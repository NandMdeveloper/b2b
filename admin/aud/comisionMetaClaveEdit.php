...
<form class="form-horizontal" method="post" action="controlcomisiones.php?opcion=editarMetaClave">
					  <input type="hidden" value="<?php echo $id; ?>" name="idm">
            <fieldset>
						<legend>Edición meta cuenta clave</legend>
            <?php
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <select class="form-control" name="co_ven" required>
                  ...
                  <option value="<?php echo $claveSeleccionada[0]['co_ven']; ?>"><?php echo $claveSeleccionada[0]['ven_des']; ?></option>
                  ...
                  <?php
                   ...
                   ?>
						...
						<div class="form-group">
						  ...
						  <div class="col-lg-10">
							<input class="form-control preciosforma" name="presupuesto"  id="presupuesto" placeholder="Presupuesto para cliente clave" type="text" required  pattern=".{5,25}" maxlength="25" value="<?php echo $nPresupuesto;?>" >
						  </div>
						</div>
            <div class="form-group">
						  <label for="inputEmail" class="col-lg-2 control-label">Inicio</label>
						  <div class="col-lg-3">
							<input class="form-control fecha" name="desde" id="desde" placeholder="Fecha inicio" type="text" required  value="<?php echo $presupuesto[0]['desde'];?>">
						  </div>
						  <label for="inputEmail" class="col-lg-2 control-label">Final</label>
						  <div class="col-lg-3">
							<input class="form-control fecha" name="hasta" id="hasta" placeholder="Fecha de finalización 1" type="text" required  value="<?php echo $presupuesto[0]['hasta'];?>">
						  </div>
						</div>
						<div class="form-group">
