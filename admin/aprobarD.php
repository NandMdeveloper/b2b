...
<body>
    ...
    <?php require_once('menuD.php'); ?>
        ...
        <div id="content">
                <div class="col-lg-12">
                    <h1 class="page-header">Detalle Pedidos - Despacho</h1>
                </div>
                <!-- /.col-lg-12 -->
                <div class="col-xs-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <hr>
                            <form role="form" action="aprobarPedD.php" method="POST">
                            ...
                            <div class="row">
                                <div class="col-xs-3 text-center">
                                   <a href="detallePedD.php?id=<?php echo $pedido; ?>"><button type="button" class="btn btn-info">Regresar</button></a>
                                </div>
                                <div class="col-xs-3 text-center">
                                    <button type="submit" class="btn btn-success" >Despachar Pedido</button>
                                </div>
